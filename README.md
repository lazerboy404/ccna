...
- **Ejercicios de configuración (200-301)**: tareas de configuración con verificación — **acceso seguro** (`enable secret`, contraseñas de consola/VTY y **SSH**), **NTP** cliente/servidor y **DHCP** (`ip dhcp pool`).
