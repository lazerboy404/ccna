...
- **Fallas simuladas (26 tipos, más allá de shutdown/VLAN)**: VLANs/trunking 802.1Q mal configurados, puertos en `shutdown`, enlaces bloqueados por STP, rutas estáticas u OSPF faltantes, **ACL que filtran tráfico**, **port-security (`err-disabled`)**, **cable cortado (se reemplaza con 🔌)**, y **equipos mal configurados**: restablecidos de fábrica, **IP duplicada**, **IP fuera del segmento** y **puerta de enlace incorrecta** (en PC, servidor y cámara).
